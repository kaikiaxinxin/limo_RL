...
# === 起始位置 ===
INIT_POS = [-7.0, 0.0]#office
# INIT_POS = [-21.0, 1.0]#maze
DT = 0.1  # 控制周期 0.1s  
# 定义序贯任务列表 (按执行顺序排列)
...
# time: 时间窗口 (秒)
TASK_CONFIG = [
    {'type': 'F', 'pos': [6.0, -6.0], 'radius': 0.3, 'time': 15.0}, # office任务 0
    {'type': 'F', 'pos': [3.0, 9.0],  'radius': 0.3, 'time': 10.0}, # office任务 1
    # {'type': 'F', 'pos': [-3.0, 5.0], 'radius': 1.5, 'time': 15.0}, # maze任务 0
    # {'type': 'F', 'pos': [-8.0, -6.0],  'radius': 1.5, 'time': 10.0}, # maze任务 1
]
